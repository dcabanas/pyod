...
class COF(BaseDetector):
    ...
    def fit(self, X, y=None):
        ...
        if self.n_neighbors >= self.n_train_:
            ...
            warnings.warn(
                ...
                "minus 1: {0}".format(self.n_neighbors))
    ...
    def _cof(self, X):
        ...
        for i in range(X.shape[0]):
            ...
            sbn_path_index.append(sbn_path[1: self.n_neighbors + 1])
            cost_desc = []
